...
class SalObjDataset(data.Dataset):
    def __init__(self, train_root, trainsize):
        ...
        self.detail_root = train_root + '/Edge/'
        

        self.images = [self.image_root + f for f in os.listdir(self.image_root) if f.endswith('.jpg') or f.endswith('.png')]
        self.gts    = [self.gt_root + f for f in os.listdir(self.gt_root) if f.endswith('.png') or f.endswith('.png')]
        self.ts     = [self.t_root + f for f in os.listdir(self.t_root) if f.endswith('.jpg') or f.endswith('.png')]
        self.bodys  = [self.body_root + f for f in os.listdir(self.body_root) if f.endswith('.png') or f.endswith('.png')]
        self.details = [self.detail_root + f for f in os.listdir(self.detail_root) if f.endswith('.png') or f.endswith('.png')]
